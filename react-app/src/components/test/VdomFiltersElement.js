    ...
    return $(PopupContext.Provider, { value: [popup, setPopup] },
        ...
        $(FilterArea, {
            ...
            buttons: [
                ...
                $(ModeButton, { key: "showAll", setState, dataKey: "showAll", flexBasis: 2, minWidth: 2, area: "lt", content: <SvgElem viewBox="0 0 17.5 19" path = "M6.74648 10.3648C6.84683 10.471 6.90585 10.6068 6.90585 10.7543V19.0001L10.4473 15.9721V10.7543C10.4473 10.6068 10.5063 10.471 10.6067 10.3648L16.5977 3.83667H0.755493L6.74648 10.3648Z M17.3532 0H0V2.6561H17.3532V0Z"/> })
            ],
        })
    )
